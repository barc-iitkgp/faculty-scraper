...
mainpage = bot.get("http://www.cs.ucsb.edu/people/")
...
for i in (1..pagination)
    page = bot.get("http://www.cs.ucsb.edu/people/#{i.to_s}")
    page.search("table th").each do |person|
        ...
        link = "http://www.cs.ucsb.edu/people/#{username}"
        email = "#{username}@cs.ucsb.edu".gsub(" ","")
